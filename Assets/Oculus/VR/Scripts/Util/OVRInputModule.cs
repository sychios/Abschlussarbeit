...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        private bool interactionIsActive = true;
        public bool InteractionIsActive
        {
            get => interactionIsActive;
            set => interactionIsActive = value;
        }
        ...
        public override void Process()
        {
            ...
            ProcessMouseEvent(GetGazePointerData()); //TODO: disable interaction here?
#if !UNITY_ANDROID
