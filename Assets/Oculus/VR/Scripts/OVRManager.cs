...
#region Unity Messages
	...
	private void InitOVRManager()
	{
		...
		Application.SetStackTraceLogType(LogType.Log, StackTraceLogType.None);  // TEMPORARY TODO: modified here
		...
		if (!staticMixedRealityCaptureInitialized)
		{
			...
			{
				//Debug.Log("OVR: Mixed Reality mode enabled"); TODO: modified here
				...
				//Debug.Log("OVR: CompositionMethod : " + compositionMethod); TODO: modified here
			}
		}
#endif
	...
	private void Update()
	{
		...
		{
			//Debug.Log("[OVRManager] OVRPlugin.shouldQuit detected"); TODO: modified here
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN || OVR_ANDROID_MRC
		...
		if (useRecommendedMSAALevel && QualitySettings.antiAliasing != display.recommendedMSAALevel)
		{
			...
			//". Switching to the recommended level."); TODO: modified here
		...
		if (_wasHmdPresent && !isHmdPresent)
		{
			try
			{
				//Debug.Log("[OVRManager] HMDLost event"); TODO: modified here
				if (HMDLost != null)
					HMDLost();
			}
			catch (Exception e)
		...
		if (!_wasHmdPresent && isHmdPresent)
		{
			try
			{
				//Debug.Log("[OVRManager] HMDAcquired event"); TODO: modified here
				if (HMDAcquired != null)
					HMDAcquired();
			}
			catch (Exception e)
			{
				//Debug.LogError("Caught Exception: " + e); TODO: modified here
			}
		}
		...
		if (_wasUserPresent && !isUserPresent)
		{
			try
			{
				//Debug.Log("[OVRManager] HMDUnmounted event"); TODO: modified here
		...
		if (!_wasUserPresent && isUserPresent)
		{
			try
			{
				//Debug.Log("[OVRManager] HMDMounted event"); TODO: modified here
				if (HMDMounted != null)
					HMDMounted();
			}
			catch (Exception e)
		...
		if (_hadVrFocus && !hasVrFocus)
		{
			try
			{
				//Debug.Log("[OVRManager] VrFocusLost event"); TODO: modified here
				if (VrFocusLost != null)
					VrFocusLost();
			}
			catch (Exception e)
		...
		if (!_hadVrFocus && hasVrFocus)
		{
			try
			{
				//Debug.Log("[OVRManager] VrFocusAcquired event"); TODO: modified here
		...
		if (_hadInputFocus && !hasInputFocus)
		{
			try
			{
				//Debug.Log("[OVRManager] InputFocusLost event"); TODO: modified here
		...
		if (!_hadInputFocus && hasInputFocus)
		{
			try
			{
				//Debug.Log("[OVRManager] InputFocusAcquired event"); TODO: modified here
		...
		else if (audioOutId != prevAudioOutId)
		{
			try
			{
				//Debug.Log("[OVRManager] AudioOutChanged event"); TODO: modified here
		...
		else if (audioInId != prevAudioInId)
		{
			try
			{
				//Debug.Log("[OVRManager] AudioInChanged event"); TODO: modified here
		...
		if (wasPositionTracked && !tracker.isPositionTracked)
		{
			try
			{
				//Debug.Log("[OVRManager] TrackingLost event"); TODO: modified here
		...
		if (!wasPositionTracked && tracker.isPositionTracked)
		{
			try
			{
				//Debug.Log("[OVRManager] TrackingAcquired event"); TODO: modified here
	...
	{
		//Debug.Log("[OVRManager] OnDestroy"); TODO: modified here
	...
	private void OnApplicationPause(bool pause)
	{
		if (pause)
		{
			//Debug.Log("[OVRManager] OnApplicationPause(true)"); TODO: modified here
		}
		else
		{
			//Debug.Log("[OVRManager] OnApplicationPause(false)"); TODO: modified here
		}
	}
	...
	private void OnApplicationFocus(bool focus)
	{
		if (focus)
		{
			//Debug.Log("[OVRManager] OnApplicationFocus(true)"); TODO: modified here
		}
		else
		{
			//Debug.Log("[OVRManager] OnApplicationFocus(false)"); TODO: modified here
		}
	}

	private void OnApplicationQuit()
	{
		//Debug.Log("[OVRManager] OnApplicationQuit"); TODO: modified here
	}
	...
	public static void StaticUpdateMixedRealityCapture(OVRMixedRealityCaptureConfiguration configuration, GameObject gameObject, TrackingOrigin trackingOrigin)
	{
		...
		if (configuration.enableMixedReality && !staticPrevEnableMixedRealityCapture)
		{
			...
			//Debug.Log("MixedRealityCapture: activate"); TODO: modified here
		}

		if (!configuration.enableMixedReality && staticPrevEnableMixedRealityCapture)
		{
			//Debug.Log("MixedRealityCapture: deactivate"); TODO: modified here
		}
